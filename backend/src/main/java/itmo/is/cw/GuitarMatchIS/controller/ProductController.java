...
public class ProductController {
   ...
   @Operation(summary = "Получить товары по бренду",
             description = "Возвращает список товаров определенного бренда с пагинацией")
   @ApiResponses(value = {
   ...
   @Operation(summary = "Получить жанры товара",
             description = "Возвращает список музыкальных жанров, для которых подходит товар")
   @ApiResponses(value = {
   ...
   @Operation(summary = "Получить статьи о товаре",
             description = "Возвращает список статей, связанных с товаром")
   @ApiResponses(value = {
   ...
   @Operation(summary = "Получить товары по типу",
             description = "Возвращает список товаров определенного типа с пагинацией")
   @ApiResponses(value = {
       @ApiResponse(responseCode = "200", description = "Список товаров успешно получен"),
       @ApiResponse(responseCode = "400", description = "Некорректные параметры запроса")
   })
   ...
   @Operation(summary = "Поиск товаров по названию",
             description = "Возвращает список товаров, содержащих указанную строку в названии")
   @ApiResponses(value = {
   ...
   @Operation(summary = "Фильтрация товаров",
             description = "Возвращает отфильтрованный список товаров по различным параметрам")
   @ApiResponses(value = {
   ...
   public List<ProductDTO> getProductsByFilter(
      ...
      return productService.getProductsByFilter(name, minRate, maxRate, brandId, guitarForm, typeOfProduct, lads,
            minPrice, maxPrice, color, strings, tipMaterial, bodyMaterial, pickupConfiguration, typeComboAmplifier, from, size);
   }
}
