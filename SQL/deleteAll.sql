...
DROP INDEX IF EXISTS idx_product_type_price_rate;
...
DROP INDEX IF EXISTS idx_shop_product_shop_price;
DROP INDEX IF EXISTS idx_shop_product_price;
DROP INDEX IF EXISTS idx_shop_product_available_product_price;
...
DROP INDEX IF EXISTS idx_feedback_product_notnull;

DROP INDEX IF EXISTS idx_articles_author_id;
DROP INDEX IF EXISTS idx_articles_header;
DROP INDEX IF EXISTS idx_articles_author_accepted;
